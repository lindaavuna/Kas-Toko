...
export default function HalamanTransaksi() {
  ...
  const batalkan = usePosStore((s) => s.batalkanPenjualan);
  ...
  function kirimVoid() {
    ...
    const hasil = batalkan(voidTarget.id, alasan.trim() || "Salah input", pin);
      ...
      <Dialog open={!!voidTarget} onOpenChange={(o) => { setVoidTarget(o ? voidTarget : null); if (!o) { setPin(""); setAlasan(""); } }}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="gap-2 sm:gap-2">
            ...
            <Button variant="danger" size="lg" onClick={kirimVoid} disabled={pin.length < 4}>
